...
//           subtotal: bookingData.subtotal,
//           total_amount: appliedPromo?.totalAmount || bookingData.subtotal,
//         }),
//       });
...
//   // Calculate taxes (6% as per image)
//   const taxRate = 0.06;
...
//         <button 
//           onClick={() => router.push('/experience/' + bookingData.experienceId)}
...
//                       className={`bg-muted/50 ${errors.customerName ? 'border-red-500' : ''}`}
//                     />
//                     {errors.customerName && (
...
//                       placeholder="Your name"
//                       className={`bg-muted/50 ${errors.customerEmail ? 'border-red-500' : ''}`}
//                     />
